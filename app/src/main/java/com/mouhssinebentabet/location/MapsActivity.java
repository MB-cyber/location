package com.mouhssinebentabet.location;
...
import com.mouhssinebentabet.location.databinding.ActivityMapsBinding;
        ...
        databaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                try {
                    ...
                    for (int i=1; i<stringLat.length;i++){
                        String latitude = stringLat[stringLat.length-i].split("=")[1];

                        String longitude = stringLong[stringLong.length-i].split("=")[1];


                        LatLng latLng = new LatLng(Double.parseDouble(latitude), Double.parseDouble(longitude));

                        mMap.addMarker(new MarkerOptions().position(latLng).title(latitude + " , " + longitude+"moh"));
